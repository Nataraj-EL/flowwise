...
export const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'Cash Flow', href: '/dashboard/cashflow', icon: TrendingUp, disabled: true, tag: 'SOON' },
    { name: 'Transactions', href: '/dashboard/transactions', icon: ArrowRightLeft, disabled: true, tag: 'SOON' },

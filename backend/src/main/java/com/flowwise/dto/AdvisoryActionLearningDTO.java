...
public class AdvisoryActionLearningDTO {
    private Long id;
    ...
    public AdvisoryActionLearningDTO() {}

    public AdvisoryActionLearningDTO(Long id, Long merchantId, String actionType, String contextType,
                                    Integer sampleCount, BigDecimal effectivenessScore,
                                    BigDecimal learningMultiplier, String confidenceStatus,
                                    String evidenceMetrics, String evaluatedAt) {
        this.id = id;

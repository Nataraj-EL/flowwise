...
public class FinancialPlanOutcomeSummaryDTO {
    ...
    private List<FinancialPlanOutcomeDTO> outcomes;
    private List<PlanOptimizationDTO> optimizationFactors;
    private String summaryExplanation;
    private String advisoryNotice;

    public FinancialPlanOutcomeSummaryDTO() {}

    public FinancialPlanOutcomeSummaryDTO(Long merchantId, int totalEvaluatedOutcomesCount, int successfulCount,
                                         int partialCount, int ineffectiveCount, int insufficientDataCount,
                                         BigDecimal averageEffectivenessScore, List<FinancialPlanOutcomeDTO> outcomes,
                                         List<PlanOptimizationDTO> optimizationFactors, String summaryExplanation,
        ...
        this.optimizationFactors = optimizationFactors;
    ...
    public List<FinancialPlanOutcomeDTO> getOutcomes() { return outcomes; }
    public void setOutcomes(List<FinancialPlanOutcomeDTO> outcomes) { this.outcomes = outcomes; }

    public List<PlanOptimizationDTO> getOptimizationFactors() { return optimizationFactors; }
    public void setOptimizationFactors(List<PlanOptimizationDTO> optimizationFactors) { this.optimizationFactors = optimizationFactors; }

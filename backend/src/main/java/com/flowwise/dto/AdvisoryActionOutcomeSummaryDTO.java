...
public class AdvisoryActionOutcomeSummaryDTO {
    ...
    private List<AdvisoryActionOutcomeDTO> outcomes;
    private List<AdvisoryActionLearningDTO> learnings;
    private String summaryExplanation;
    private String advisoryNotice;

    public AdvisoryActionOutcomeSummaryDTO() {}

    public AdvisoryActionOutcomeSummaryDTO(Long merchantId, int totalEvaluatedOutcomesCount,
                                           int successfulCount, int partialCount, int ineffectiveCount,
                                           int insufficientDataCount, BigDecimal averageEffectivenessScore,
                                           List<AdvisoryActionOutcomeDTO> outcomes,
                                           List<AdvisoryActionLearningDTO> learnings,
    ...
    public List<AdvisoryActionOutcomeDTO> getOutcomes() { return outcomes; }
    public void setOutcomes(List<AdvisoryActionOutcomeDTO> outcomes) { this.outcomes = outcomes; }

    public List<AdvisoryActionLearningDTO> getLearnings() { return learnings; }
    public void setLearnings(List<AdvisoryActionLearningDTO> learnings) { this.learnings = learnings; }

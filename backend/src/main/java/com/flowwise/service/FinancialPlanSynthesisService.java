...
public class FinancialPlanSynthesisService {
    ...
    public FinancialPlanSummaryDTO evaluateFinancialPlan(Long merchantId, String horizon) {
        ...
        String assumptions = "Plan items synthesize risks, anomalies, correlations, interventions, outcomes, learned strategy multipliers, evaluated scenarios, and decision intelligence recommendations (ADVISORY_RECOMMENDATION) without automated fund execution.";

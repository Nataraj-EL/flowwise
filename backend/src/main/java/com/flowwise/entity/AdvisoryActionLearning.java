...
@Entity
@Table(name = "advisory_action_learning", uniqueConstraints = {
    @UniqueConstraint(name = "uk_advisory_action_learning_type_context", columnNames = {"merchant_id", "action_type", "context_type"})
})
public class AdvisoryActionLearning {
    ...
    public AdvisoryActionLearning() {}

    public AdvisoryActionLearning(Merchant merchant, String actionType, String contextType,
